...
export DOCKER_REGISTRY   ?= pcrespov
export DOCKER_IMAGE_NAME ?= pcrespov-test-service
...
APP_NAME := pcrespov-test-service
...
replay: .cookiecutterrc ## re-applies cookiecutter
	# Replaying /home/crespo/devp/cookiecutter-osparc-service ...
	@cookiecutter --no-input --overwrite-if-exists \
		--config-file=$< \
		--output-dir="$(abspath $(CURDIR)/..)" \
		"/home/crespo/devp/cookiecutter-osparc-service"
